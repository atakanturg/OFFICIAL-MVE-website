...
export function ContactCard({ name, title, email }: ContactCardProps) {
  return (
    <motion.div
      ...
      className="bg-[#111111] border border-white/[0.06] rounded-lg p-6 flex flex-col items-start text-left group hover:border-[#58C391]/20 transition-colors"
    >
      ...
      <a
        href={`mailto:${email}`}
        className="text-[#58C391] font-semibold text-[10px] tracking-wide uppercase hover:gap-3 transition-all mt-auto flex items-center gap-2 link-underline"
      >
