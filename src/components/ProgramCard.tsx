  ...
  return (
    <div className="block py-6 group w-full text-left border-b border-white/[0.05] last:border-0">
      <div className="flex items-center gap-3 mb-2">
        <Link href={href}>
          <a className="flex items-center gap-3 cursor-pointer group/title">
            <h3 className="text-2xl md:text-3xl font-heading font-bold uppercase tracking-tight group-hover/title:text-[#C8A55C] transition-all duration-300">
              {title}
            </h3>
            <span className="text-xl text-[#F5F5F0] group-hover/title:text-[#C8A55C] group-hover/title:translate-x-1 transition-all duration-300">
              →
            </span>
          </a>
        </Link>
