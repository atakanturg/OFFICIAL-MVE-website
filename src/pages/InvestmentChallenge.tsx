  ...
  return (
    <PageTransition>
      <div className="min-h-screen pt-28 pb-20 px-6 md:px-12 max-w-5xl mx-auto flex flex-col items-center text-center tracking-wide pointer-events-auto">
        ...
        >
          Investment <span className="italic text-[#58C391] font-heading font-bold">Fund</span>
        </motion.h1>
        ...
        >
          <h2 className="text-xs font-bold tracking-[0.3em] uppercase text-[#58C391] mb-8 flex items-center justify-center gap-3">
            Applications
          </h2>
